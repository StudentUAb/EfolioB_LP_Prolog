...
public class SistemaBancario {
    ...
    private void mostrarSaldoRealCliente() {
        ...
        if (cliente != null) {
            System.out.println("Saldo Total do Cliente " + cliente.getNome() + ":");
            Query query = new Query("balanco_total(" + numeroCliente + ", SaldoTotal)");
            if (query.hasSolution()) {
                int saldoTotal = Integer.parseInt(query.oneSolution().get("SaldoTotal").toString());
                System.out.println("Saldo Total: " + saldoTotal);
            } else {
                System.out.println("Não foi possível obter o saldo total do cliente.");
            }
        } else {
    ...
    public void exibirMenu() {
        ...
        while (opcao != 7) {
            System.out.println("\n--** Menu do Sistema Bancário **--");
            System.out.println("1 - Mostrar Lista de Clientes e suas informações");
            System.out.println("2 - Mostrar Saldo Real de um Cliente (com crédito)");
...
}//Fim da classe Sistema Bancário